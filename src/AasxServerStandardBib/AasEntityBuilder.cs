    ...
    public class AasEntityBuilder
    {
        ...
        public void CreateAddInstanceObjects(AdminShell.AdministrationShellEnv env)
        {
            ...
            foreach (var la in this.noteLateActions)
            {
                    ...
                    && this.packages != null)
                {
                    ...
                    if (!lax.uanode.ReferenceExists(this.AasTypes.HasAasReference.GetTypeNodeId(), false, targetNodeRec.uanode.NodeId))
                    ...
                    && this.packages != null)
                {
                    ...
                    if (!foundAtAll && lax.targetReference.Keys.Count == 1)
                    {
                        ...
                        if (nr != null)
                        {
                            ...
                            if (!lax.uanode.ReferenceExists(this.AasTypes.HasDictionaryEntry.GetTypeNodeId(), false, nr.uanode?.NodeId))
                        ...
                        else
                        {
                            ...
                            if (this.RootMissingDictionaryEntries != null)
                            {
                                ...
                                // add the reference
                                if (!lax.uanode.ReferenceExists(this.AasTypes.HasDictionaryEntry.GetTypeNodeId(), false, miss?.NodeId))
                            ...
                            else
                            {
                                ...
                                if (!lax.uanode.ReferenceExists(this.AasTypes.HasDictionaryEntry.GetTypeNodeId(), false, missingTarget))
            ...
            string extraName = null)
        {
            ...
            if (referenceTypeFromParentId != null)
            {
                if (parent != null)
                {
                    //TODO (MAPA, 2022-11-16) : check s Rudom -> cele prec
